...
- Introduced `Container::get_host_port_ipv4` and `Container::get_host_port_ipv6` to better handle automatically assigned ports.
...
- `Container::get_host_port` is now deprecated in favor of the new IPv4- and IPv6-specific methods.
